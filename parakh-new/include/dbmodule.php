...
//end of fun
    ...
    function addRating($data) {
        ...
        if ($rating_last_insert) {
            ...
            $vars = array(
                "{Username}" => firstNameSendEmail($email_data['to']['name']),
            ...
            $vars = array(
                "{Username}" => firstNameSendEmail($this->manager_name),
            ...
            if ($getNewRatingPostion!=0 && ($getNewRatingPostion <= 10 || $getOldRatingPostion > $getNewRatingPostion)) {
                ...
                $email_data['subject'] = $temp_data['subject'];
                $vars = array(
                    "{Username}" => firstNameSendEmail($user_data['google_name']),
    ...
    function get_last_month_login_users() {
        ...
        foreach ($last_login_users as $value) {
            if (isset($value['google_email']) && !empty($value['google_email'])) {
                ...
                $email_data['subject'] = $temp_data['subject'];
                $vars = array(
                    "{Username}" => firstNameSendEmail($value['google_name']),
