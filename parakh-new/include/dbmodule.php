...
//end of fun
    ...
    function get_top_rankers_calendar_wise($lead_id){
        ...
        $query_rank_till_now_wise = "SELECT sum(case when r.rating = 1 then 1  end) as pluscount,sum(case when r.rating = 0 then 1  end) as minuscount FROM rating as r AND user_id in (select user_id from user_hierarchy where manager_id =:lead_id)";
